...
{
	/*
	This file has been imported directly from Apache Flex, to reduce external dependencies.
	...
	*/
	...
	public class Base64Decoder
	{
		...
		public function flush():ByteArray
		{
			if (count > 0)
			{
				throw new Error("Base64Decoder: A partial block (" + count +
					" of 4 bytes) was dropped. Decoded data is probably truncated!");
			}
			return drain();
		}
