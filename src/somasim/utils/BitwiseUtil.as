...
{
	/** 
	 * Contains utilities for bitwise operations, usually on integers.
	 */
	public class BitwiseUtil
	{
		 ...
		 * </pre>
		 */
		public static function reverseBits (x :uint) :uint {
		 ...
		 */
		public static function shuffleBits (x :uint) :uint {
			var t :uint = 0;
		 ...
		 */
		public static function unshuffleBits (x :uint) :uint {
			var t :uint = 0;
			t = (x ^ (x >>> 1)) & 0x22222222; x = x ^ t ^ (t << 1);
			t = (x ^ (x >>> 2)) & 0x0c0c0c0c; x = x ^ t ^ (t << 2);
			t = (x ^ (x >>> 4)) & 0x00f000f0; x = x ^ t ^ (t << 4);
